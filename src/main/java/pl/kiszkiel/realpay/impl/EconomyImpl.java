...
public class EconomyImpl implements Economy {
    ...
    public String getName() {
        return RealPay.getPlugin(RealPay.class).getName();
    }
    ...
    public String format(double amount) {
        return String.format("%f,.2", amount);
    }
    ...
    public String currencyNamePlural() {
        return RealPay.getPlugin(RealPay.class).currencyNamePlural();
    }
    ...
    public String currencyNameSingular() {
        return RealPay.getPlugin(RealPay.class).currencyNameSingular();
    }
